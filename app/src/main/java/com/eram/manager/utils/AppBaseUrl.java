...
public class AppBaseUrl {
    ...
    public static final String GET_POOL_RECEPTION_DAY = "/mng_get_pool_reception_day";
    public static final String GET_POOL_RECEPTION_LIMIT = "/mng_get_pool_reception_limit";
    public static final String GET_POOL_RECEPTION_STATUS = "/mng_get_pool_reception_status";
